...
class PizzaServiceTest {
    ...
    @BeforeEach
    void setUp() {
        this.service = new PizzaService(new MenuRepository("data/menu.txt"), new PaymentRepository(filename));
    ...
    void checkBBT(int table, PaymentType type, double amount) {
        File file = new File(filename);
